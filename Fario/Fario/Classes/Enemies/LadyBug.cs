...
{
    public class LadyBug : PatrolingEnemy
    {
        public LadyBug(ContentManager Content, Vector2 location)
        {
            ...
            animations.Add(
                ...
                new AnimationStrip(
                    texture,
                    Content.Load<Rectangle[]>(@"SheetData/Enemies/LadyBug/LadyBugWalk"),
                    "Walk"));
            ...
            animations.Add(
                ...
                new AnimationStrip(
                    texture,
                    Content.Load<Rectangle[]>(@"SheetData\Enemies\LadyBug\LadyBugHurt"),
                    "Hurt"));
            ...
            animations.Add(
                ...
                new AnimationStrip(
                    texture,
                    Content.Load<Rectangle>(@"SheetData\Enemies\LadyBug\LadyBugDead"),
                    "Dead"));
