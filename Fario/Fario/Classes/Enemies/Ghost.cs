...
{
    public class Ghost : PatrolingEnemy
    {
        public Ghost(ContentManager content, Vector2 location)
        {
            ...
            animations.Add(
                ...
                new AnimationStrip(
                    texture,
                    content.Load<Rectangle>(@"SheetData/Enemies/Ghost/GhostWalk"),
                    "Walk"));
            ...
            animations.Add(
                ...
                new AnimationStrip(
                    texture,
                    content.Load<Rectangle[]>(@"SheetData\Enemies\Ghost\GhostHurt"),
                    "Hurt"));
            ...
            animations.Add(
                ...
                new AnimationStrip(
                    texture,
                    content.Load<Rectangle>(@"SheetData\Enemies\Ghost\GhostDead"),
                    "Dead"));
